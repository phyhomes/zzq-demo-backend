...
public class Platform extends UserAgentInfo {
     ...
     * 支持的移动平台类型
     */
    public static final List<Platform> mobilePlatforms = new ArrayList<>(11);
    static {
        Collections.addAll(mobilePlatforms,
                WINDOWS_PHONE, //
                IPAD, //
                IPOD, //
                IPHONE, //
     ...
     * 支持的桌面平台类型
     */
    public static final List<Platform> desktopPlatforms = new ArrayList<>(6);
    static {
        Collections.addAll(desktopPlatforms,
